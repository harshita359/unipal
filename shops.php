                ...
                <div class="container discounts-container">
                    ...
                    <div class="row filtration-container" style="padding: 40px 0;">
                        <div class="col-lg-6 title-container">
                            <h1 class="typography sub-heading" style="line-height:0.9;">Cafes</h1>
                        </div>
                        <div class="col-lg-4 col-sm-8 offer-search-div">
                            <div class="form-group" style="margin:0;">
                                <div class="input-group">
                                    <form action="/en-bh/student-discounts/categories/cafes-coffee-shops-offers" id="offersForm" method="get"><input class="rounded-inputs offer-search-input" id="search" name="Term" placeholder="Where would you like to shop?" style="border-radius: 20px 0 0 20px;" type="search" value="" /></form> <span id="searchButton" class="input-group-addon rounded-inputs"
                                        style="cursor: pointer; border-radius: 0 20px 20px 0;"><i class="fas fa-search"></i></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-sm-4" style="padding: 0px;">
                            <select class="rounded-inputs offer-categories-dropdown" id="category" name="CategoryId" style="padding-right: 30px;"><option value="">Categories ✨</option>
<option selected="selected" value="cafes-coffee-shops-offers">Cafes</option>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="row" style="margin: 0px -20px;text-align:center;">
                                ...
                                <a href="/en-bh/student-discounts/cbtl">
                                ...
                                <a href="/en-bh/student-discounts/dose-cafe">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                                <img data-src="image/u5bc3d31c-bbc2-40b6-b2e8-fc395467377a.jpeg" class="lozad" alt="20% Off! discount at Dose Cafe" />
                                            </div>
                                            <div style="padding:8px 12px;">
                                ...
                                <a href="/en-bh/student-discounts/caribou-coffee">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                ...
                                <a href="/en-bh/student-discounts/jasmis-coffee">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                ...
                                <a href="/en-bh/student-discounts/derby">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                                <img data-src="image/u/s/01HSDWGCHCTAPB1THHGZHDSZ08.jpeg" class="lozad" alt="10% Off! discount at Derby Cafe" />
                                            </div>
                                            <div style="padding:8px 12px;">
                                ...
                                <a href="/en-bh/student-discounts/milkd-station-cafe">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                ...
                                <a href="/en-bh/student-discounts/guji-specialty-coffee">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                ...
                                <a href="/en-bh/student-discounts/mug-cafe">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                ...
                                <a href="/en-bh/student-discounts/caf">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                                <img data-src="image/u/3c83adaa-7a46-47c6-8c7f-a4e2398af24b.png" class="lozad" alt="20% Off! discount at CAF" />
                                            </div>
                                            <div style="padding:8px 12px;">
                                                <h4 class="offer-shop-name">CAF</h4>
                                                <h3 class="offer-name">20% Off!</h3>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="/en-bh/student-discounts/tim-hortons">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                                <img data-src="image/u/s/01HJ09TMJF0QHKBSSM2CVPW61K.jpeg" class="lozad" alt="20% Off! discount at Tim Hortons" />
                                            </div>
                                            <div style="padding:8px 12px;">
                                                <h4 class="offer-shop-name">Tim Hortons</h4>
                                                <h3 class="offer-name">20% Off!</h3>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="/en-bh/student-discounts/illy">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                                <img data-src="image/u/f43f0b30-61f1-4127-93a3-caa669d5a3f3.jpg" class="lozad" alt="20% Off! discount at illy" />
                                            </div>
                                            <div style="padding:8px 12px;">
                                                <h4 class="offer-shop-name">illy</h4>
                                                <h3 class="offer-name">20% Off!</h3>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="/en-bh/student-discounts/beand-coffee-bar">
                                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 float-right" style="padding:10px;">
                                        <div class="card-view offer-card">
                                            <div class="ratio-container r16-9">
                                                <img data-src="image/u/cea2fbbf-a642-4d44-bb6f-f18f8389340f.jpeg" class="lozad" alt="20% Off! discount at Beand Coffee Bar" />
                                            </div>
                                            <div style="padding:8px 12px;">
                                                <h4 class="offer-shop-name">Beand Coffee Bar</h4>
                                                <h3 class="offer-name">20% Off!</h3>
                                            </div>
                                        </div>
                                    </div>
